...
<body class="bg-gray-100">
    <div class="container mx-auto p-4">
        <?php if($user && $user->post == 'administration'): ?>
            ...
            <div x-data="{ showActivityForm: false, showReservations: false, showActivities: false }">
                ...
                <div
 x-show="showReservations" class="mb-8">
        ...
        <?php else: ?>
            <p class="text-xl">Vous n'avez pas les droits nécessaires pour accéder à cette page.</p>
        <?php endif; ?>
    </div>
</body>
</html>
